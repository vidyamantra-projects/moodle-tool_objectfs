...
$string['settings:deletelocal_help'] = 'Delete local objects above minimum size threshold once they are in external object storage after the consistency delay.';
$string['settings:keepallfilesexternally'] = 'Duplicate all files';
$string['settings:keepallfilesexternally_help'] = 'Duplicate all objects on external storage for full backup/disaster recovery even while keeping the objects less than size threshold on local storage for avoiding latency.';
